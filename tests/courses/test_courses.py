...
class TestCourses:
    @allure.title('Check empty Courses List page')
    ...
    @allure.title('Check creating course')
    @allure.severity(Severity.BLOCKER)
    def test_create_course(self, create_course_page: CreateCoursePage, courses_list_page: CoursesListPage):
        create_course_page.visit(f'{AppRoute.COURSES}/create')
    ...
    @allure.title('Check creating and editing course')
    ...
    def test_edit_course(self, create_course_page: CreateCoursePage, courses_list_page: CoursesListPage):
        ...
        create_course_page.create_course_form.fill(
            title='Selenium', estimated_time='44 weeks', description='Selenium', max_score='200', min_score='20')
        create_course_page.create_course_toolbar.click_create_course_button()
        courses_list_page.course_view.check_visible(index=0,
                                                    title='Selenium', estimated_time='44 weeks', max_score='200',
                                                    min_score='20')

...
class TestAuthorization:
    ...
    def test_successful_authorization(
        ...
        registration_page.registration_form.fill('username@mail.com', 'user', 'password')
        ...
        login_page.login_form.fill('username@mail.com', 'password')
        login_page.click_login_button()
    ...
    @allure.title('User navigate from Authorization page to Registration page')
    @allure.severity(Severity.NORMAL)
    def test_navigate_from_authorization_to_registration(self, login_page: LoginPage, registration_page: RegistrationPage):
        ...
        registration_page.registration_button.check_visible()
        registration_page.registration_button.check_disabled()
        registration_page.registration_button.check_have_text('Registration')